    ...
    return (
        <>
            ...
            <section className="relative min-h-[calc(100vh-160px)] w-full overflow-hidden bg-[linear-gradient(135deg,_#3D1A2E_0%,_#5B1A6B_40%,_#6B0AC9_100%)] flex items-center justify-center px-4 py-16 sm:py-20">
                ...
                <div className="absolute top-1/3 right-20 w-4 h-4 rounded-full bg-[#F7941D]/70 nf-float opacity-70 hidden md:block" style={{ animationDelay: "1s" }} />
                <div className="absolute bottom-1/4 right-1/3 w-2 h-2 rounded-full bg-white nf-pulse opacity-60 hidden md:block" style={{ animationDelay: "2s" }} />
                ...
                <div className="relative z-10 max-w-3xl mx-auto text-center">
                    ...
                    <div className="relative mb-6 sm:mb-8 nf-fade-up">
                        ...
                        <h1 className="relative text-[110px] sm:text-[180px] md:text-[220px] lg:text-[260px] font-black leading-none tracking-tighter">
                            ...
                            <span className="inline-block text-transparent bg-clip-text bg-gradient-to-br from-[#F7941D] to-[#FF7A00] nf-pulse drop-shadow-2xl">0</span>
                            <span className="text-white drop-shadow-2xl nf-shake inline-block">4</span>
                        </h1>
                    </div>

                    {/* Title */}
                    <h2 className="nf-fade-up text-3xl sm:text-4xl md:text-5xl font-black text-white mb-4 leading-tight drop-shadow-lg" style={{ animationDelay: "0.2s" }}>
                        Page Not Found
                    </h2>

                    {/* Description */}
                    <p className="nf-fade-up text-base sm:text-lg md:text-xl text-white/85 mb-8 sm:mb-10 max-w-xl mx-auto leading-relaxed" style={{ animationDelay: "0.35s" }}>
                        Oops! The page you&apos;re looking for doesn&apos;t exist or has been moved.
                        Let&apos;s get you back on track.
                    </p>

                    {/* Action Buttons — premium style */}
                    <div className="nf-fade-up flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-5 mb-12 sm:mb-14" style={{ animationDelay: "0.5s" }}>
